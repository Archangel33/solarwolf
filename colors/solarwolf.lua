...
function M.setup(opts)
	...
	-- SmiteshP/nvim-navic
	Group.new("NavicIconsFile", colors.base0)
	Group.new("NavicIconsModule", colors.blue)
	Group.new("NavicIconsNamespace", colors.orange)
	Group.new("NavicIconsPackage", colors.yellow)
	Group.new("NavicIconsClass", colors.magenta)
	Group.new("NavicIconsMethod", colors.red)
	Group.new("NavicIconsProperty", colors.red)
	Group.new("NavicIconsField", colors.red)
	Group.new("NavicIconsConstructor", colors.magenta)
	Group.new("NavicIconsEnum", colors.blue)
	Group.new("NavicIconsInterface", colors.cyan)
	Group.new("NavicIconsFunction", colors.magenta)
	Group.new("NavicIconsVariable", colors.yellow)
	Group.new("NavicIconsConstant", colors.magenta)
	Group.new("NavicIconsString", colors.cyan)
	Group.new("NavicIconsNumber", colors.cyan)
	Group.new("NavicIconsBoolean", colors.blue)
	Group.new("NavicIconsArray", colors.blue)
	Group.new("NavicIconsObject", colors.red)
	Group.new("NavicIconsKey", colors.yellow)
	Group.new("NavicIconsNull", colors.red)
	Group.new("NavicIconsEnumMember", colors.cyan)
	Group.new("NavicIconsStruct", colors.magenta)
	Group.new("NavicIconsEvent", colors.yellow)
	Group.new("NavicIconsOperator", colors.green)
	Group.new("NavicIconsTypeParameter", colors.blue)
